...
* **RACROUTE REQUEST=AUTH**: RACF resource authorization checking.
  * More details about **RACROUTE** can be found in the [IBM documentation](https://www.ibm.com/docs/en/zos/3.1.0?topic=racf-zos-security-server-racroute-macro-reference).
