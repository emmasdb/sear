...
std::string convert(std::string_view input, std::string_view inputCodepage,
  ...
  char* src_ptr = inputString.data();
  size_t src_size = inputString.size();
...
std::string SEAR::toUTF8(std::string_view input, std::string_view codepage) {
...
std::string SEAR::fromUTF8(std::string_view input, std::string_view codepage) {
