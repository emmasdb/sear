...
void IRRSMO00::call_irrsmo00(SecurityRequest &request,
  ...
  running_userid_t running_userid_struct = {0, {0}};
  running_userid_struct.running_userid_length = static_cast<unsigned char>(
...
bool IRRSMO00::does_profile_exist(SecurityRequest &request) {
  ...
  std::memcpy(request_unique_ptr_ebcdic.get(), request_str_ebcdic.c_str(),
